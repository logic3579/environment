...
opt.sessionoptions =
"blank,buffers,curdir,folds,help,tabpages,winsize,winpos,terminal,localoptions" -- auto-session plugin
...
if vim.g.neovide then
    ...
    vim.keymap.set({ "n", "i" }, "<D-=>", function() change_scale(1.1) end, { desc = "Neovide zoom in" })
    vim.keymap.set({ "n", "i" }, "<D-->", function() change_scale(1 / 1.1) end, { desc = "Neovide zoom out" })
    vim.keymap.set({ "n", "i" }, "<D-0>", function() vim.g.neovide_scale_factor = 1.0 end,
